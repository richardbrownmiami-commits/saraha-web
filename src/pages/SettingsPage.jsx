      ...
      <div className="max-w-3xl mx-auto p-4 md:p-6 space-y-4">
        ...
        <Section title={t('settings.about')}>
          <div className="text-center py-4">
            ...
            <a href="https://github.com/richardbrownmiami-commits/saraha-app/releases/download/latest/app-release-unsigned.apk" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 mt-3 px-5 py-2.5 bg-[var(--color-brand)] hover:bg-[var(--color-brand-dark)] text-white rounded-xl text-sm font-medium transition-colors shadow-md"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg> Download APK (Android)</a>
